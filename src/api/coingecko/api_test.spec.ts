...
describe("AssetPlatformsApi", () => {
  ...
  test("assetPlatformsGet", () => expect(instance.assetPlatformsGet({})).resolves.toBe(null));
});
...
describe("CategoriesApi", () => {
  ...
  test("coinsCategoriesListGet", () => expect(instance.coinsCategoriesListGet({})).resolves.toBe(null));
});
...
describe("CoinsApi", () => {
  ...
  test("coinsIdGet", () => {
    ...
    return expect(
      instance.coinsIdGet(id, localization, tickers, marketData, communityData, developerData, sparkline, {}),
    ).resolves.toBe(null);
  });
  ...
  test("coinsIdTickersGet", () => {
    ...
    return expect(
      instance.coinsIdTickersGet(id, exchangeIds, includeExchangeLogo, page, order, depth, {}),
    ).resolves.toBe(null);
  });
  test("coinsListGet", () => {
  ...
  test("coinsMarketsGet", () => {
    ...
    return expect(
      instance.coinsMarketsGet(vsCurrency, ids, category, order, perPage, page, sparkline, priceChangePercentage, {}),
    ).resolves.toBe(null);
  });
});
...
describe("ContractApi", () => {
  ...
  test("coinsIdContractContractAddressMarketChartGet", () => {
    ...
    const days: string = "days_example";
    return expect(
      instance.coinsIdContractContractAddressMarketChartGet(id, contractAddress, vsCurrency, days, {}),
    ).resolves.toBe(null);
  });
  test("coinsIdContractContractAddressMarketChartRangeGet", () => {
    ...
    const to: string = "to_example";
    return expect(
      instance.coinsIdContractContractAddressMarketChartRangeGet(id, contractAddress, vsCurrency, from, to, {}),
    ).resolves.toBe(null);
  });
});
...
describe("DerivativesApi", () => {
  ...
  test("derivativesExchangesListGet", () => expect(instance.derivativesExchangesListGet({})).resolves.toBe(null));
  test("derivativesGet", () => {
    const includeTickers: string = "includeTickers_example";
...
describe("ExchangeRatesApi", () => {
  ...
  test("exchangeRatesGet", () => expect(instance.exchangeRatesGet({})).resolves.toBe(null));
});
...
describe("ExchangesApi", () => {
  ...
  test("exchangesIdTickersGet", () => {
    ...
    const order: string = "order_example";
    return expect(
      instance.exchangesIdTickersGet(id, coinIds, includeExchangeLogo, page, depth, order, {}),
    ).resolves.toBe(null);
  });
  ...
  test("exchangesListGet", () => expect(instance.exchangesListGet({})).resolves.toBe(null));
});
...
describe("GlobalApi", () => {
  ...
  test("globalDecentralizedFinanceDefiGet", () =>
    expect(instance.globalDecentralizedFinanceDefiGet({})).resolves.toBe(null));
  test("globalGet", () => expect(instance.globalGet({})).resolves.toBe(null));
});
...
describe("IndexesApi", () => {
  ...
  test("indexesListGet", () => expect(instance.indexesListGet({})).resolves.toBe(null));
...
describe("PingApi", () => {
  ...
  test("pingGet", () => expect(instance.pingGet({})).resolves.toBe(null));
});
...
describe("SimpleApi", () => {
  ...
  test("simpleSupportedVsCurrenciesGet", () => expect(instance.simpleSupportedVsCurrenciesGet({})).resolves.toBe(null));
  test("simpleTokenPriceIdGet", () => {
    ...
    const includeLastUpdatedAt: string = "includeLastUpdatedAt_example";
    return expect(
      instance.simpleTokenPriceIdGet(
        id,
        contractAddresses,
        vsCurrencies,
        includeMarketCap,
...
describe("TrendingApi", () => {
  ...
  test("searchTrendingGet", () => expect(instance.searchTrendingGet({})).resolves.toBe(null));
});
