...
import { DefaultExplorer, Init } from "src/types";
...
const PreferredExplorerProvider = ({
  ...
  defaultExplorer: Init["defaultExplorer"];
  children: ReactNode;
}) => {
  ...
  return (
    <PreferredExplorerContext.Provider
      value={{
        ...
        getExplorer,
        getTokenExplorer,
        setExplorer: (explorer: DefaultExplorer) => setExplorer(explorer),
      }}
    >
      {children}
    </PreferredExplorerContext.Provider>
